...
/**
 * Implementation of the {@link StockQueryService} interface that handles queries related to stock information.
 */
@Slf4j
@Service
public class StockQueryServiceImpl implements StockQueryService {
    ...
    public StockQueryServiceImpl(ProductRepository productRepository, StockRepository stockRepository) {
